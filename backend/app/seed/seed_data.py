    ...
    for i, b in enumerate(bands):
        db.add(
            RateBand(
                ...
                min_passengers=b.get("min_passengers"),
                max_passengers=b.get("max_passengers"),
                min_tonnage=b.get("min_tonnage"),
                max_tonnage=b.get("max_tonnage"),
    ...
    for insurer_code, insurer_data in INSURERS.items():
        ...
        for class_code, class_data in insurer_data["classes"].items():
            ...
            motor_class = MotorClass(
                ...
                pll_included=class_data.get("pll_included", False),
                commercial_use=class_data.get("commercial_use"),
                eligible_institution_types=class_data.get("eligible_institution_types"),
                eligible_vehicle_types=class_data.get("eligible_vehicle_types"),
                eligible_passenger_categories=class_data.get("eligible_passenger_categories"),
                tonnage_required=class_data.get("tonnage_required", False),
