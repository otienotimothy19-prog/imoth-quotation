...
def motor_class_to_dict(mc: MotorClass) -> dict:
    ...
    return {
        ...
        "pll_included": mc.pll_included,
        "commercial_use": mc.commercial_use,
        "eligible_institution_types": mc.eligible_institution_types,
        "eligible_vehicle_types": mc.eligible_vehicle_types,
        "eligible_passenger_categories": mc.eligible_passenger_categories,
        "tonnage_required": mc.tonnage_required,
